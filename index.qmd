...
My toolbox includes R, SQL, statistical modeling, Tableau, Quarto, PowerPoint, and Canva. I'm also comfortable with version control on GitHub to ensure clean and collaborative workflows.
...
portfolio_gallery <- function() {
  div(class = "portfolio-gallery",
    ...
    div(class = "portfolio-item",
        ...
        h3(class = "portfolio-title", "Water delivery method"),
        p(class = "portfolio-date", "October 2023")
    ),
    ...
    div(class = "portfolio-item",
        ...
        h3(class = "portfolio-title", "Calves in Group Housing"),
        p(class = "portfolio-date", "May 2024")
    ),
    
    # Item 3 (Ver portfólio completo)
    div(class = "portfolio-item see-more",
        a(href = "projects.qmd", class = "full-portfolio-link",
          img(src = "images/analise-estatistica-de-dados-por-que-sua-empresa-precisa-se-preocupar-com-isso.jpg", class = "portfolio-image", alt = "Full Portfolio"),
...
formspree_form <- function(form_id) {
  tags$div(
    class = "contact-form",
    tags$form(
      action = paste0("https://formspree.io/f/xjkwbbgg", form_id),
      method = "POST",
      tags$div(
        class = "form-group",
