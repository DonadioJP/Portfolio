...
portfolio_gallery <- function() {
  div(class = "portfolio-gallery",
    ...
    div(class = "portfolio-item",
        a(href = "bbc_scraping.qmd",
          img(src = "images/animal-welfare.jpg", class = "portfolio-image", alt = "animal welfare")
        ),
        p(class = "portfolio-theme", "Web Scraping"),
        h3(class = "portfolio-title", "Quantifying Animal Welfare Narratives in BBC News"),
        p(class = "portfolio-date", "July 2025")
    )
  )
}
