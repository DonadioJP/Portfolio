...
```{r}
#| echo: false
languages <- c("Portuguese (Native)", "English (Fluent)", "Spanish (Fluent)", "French (Basic)")

tagList(
  lapply(languages, function(languages) {
    div(class = "skill-box", languages)
  })
)
```
